...
import {
  FillReviewOverlay,
  type FillPreview,
} from '../../collection/pages/FillReviewPage';
import {
  SettingsOverlay,
  type PluginSettingsForm,
  type VscodeConfigDisplay,
} from '../../settings/pages/SettingsPage';
import { ProfileOverlay } from '../../settings/pages/ProfilePage';
import {
  CollectLoadingOverlay,
  type CollectLoadingState,
} from '../../shared/views/CollectLoadingOverlay';
import { ScopeToggle, type CollectView } from '../../shared/views/ScopeToggle';
import {
  type CollectRequest,
