...
import {
  ...
  isReleaseNoiseText,
  truncateForLog,
} from '../../shared/utils/ailogFilter';
import {
  AILOG_MODULE_SEP,
  buildRepoPrefixHints,
  normalizeAilogPrefixes,
  parseAilogItem,
} from '../../shared/utils/ailogPrefix';
import { OpenAiCompatibleClient } from './openAiCompatibleClient';
import { resolveAiSystemPrompt } from '../../settings/utils/aiSystemPrompt';
import type { PluginSettings } from '../../settings/types/pluginSettings';
import { AI_PRESETS } from '../../settings/types/pluginSettings';
import {
  applyWeekendAilogRollforward,
  buildAiPolishDayInputs,
} from '../../shared/utils/weekendCommitRollforward';
