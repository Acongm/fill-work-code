...
export const MSG_SEND_EMAIL = 'sendEmail';
...
export const MSG_SELECT_XLSX_IMPORT = 'selectXlsxImport';
export const MSG_CONFIRM_IMPORT = 'confirmImport';
export const MSG_AI_GENERATE_ALL = 'aiGenerateAll';
export const MSG_LIST_MONTH_FILES = 'listMonthFiles';
...
export const MSG_REFRESH_CONFIG = 'refreshConfig';
